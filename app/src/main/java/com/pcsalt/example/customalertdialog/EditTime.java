...
import static com.pcsalt.example.customalertdialog.CustomAdapter.context;
...
public class EditTime extends AppCompatActivity {
    ...
    private TextView setoperation_txt;
            ...
            if (entity != null) {
                ...
                for (int i = 0; i < jsonarray.length(); i++) {
                    ...
                    if (name1.equals("Cyclic")) {
                        devicename1 = jsonobject.getString("DeviceName");
                        devicetype1 = jsonobject.getString("DeviceType");
                        ...
                        ontimerep1 = jsonobject.getString("FromTime");
                        offtimerep1 = jsonobject.getString("ToTime");
                        ontime1 = jsonobject.getString("OnTime");
                        offtime1 = jsonobject.getString("OffTime");
                    ...
                    //   if (jsonarray.equals("Repeat On Days")) {
                        ...
                        date1 = jsonobject.getString("Date");
                        time1 = jsonobject.getString("Time");
                        ontimerep1 = jsonobject.getString("OnTimeRep");
                        offtimerep1 = jsonobject.getString("OffTimeRep");
                        ondatarep1 = jsonobject.getString("OnDataRep");
                        offdatarep1 = jsonobject.getString("OffDataRep");
                        repeatweekly1 = jsonobject.getString("RepeatWeekly");
                        ontime1 = jsonobject.getString("FromTime");
                        offtime1 = jsonobject.getString("ToTime");
                        devnum = jsonobject.getString("DeviceNO");
    ...
    private void set_timer() {
      ...
      //  final LayoutInflater inflater1 = getLayoutInflater();
        if(device.equals("SWITCH")) {
            alertLayout = inflater.inflate(R.layout.edit_layout_custom_dialog, null);
            setoperation = (Button) alertLayout.findViewById(R.id.setoperation);
            setoperation_txt = (TextView) alertLayout.findViewById(R.id.setoperation_txt);
            setoperation.setAlpha(0);
            setoperation_txt.setAlpha(0);
        }
        else  if(device.equals("RGB")) {
            alertLayout = inflater.inflate(R.layout.edit_layout_custom_dialog, null);
        }
        else  if(device.equals("DIMMER")) {
            alertLayout = inflater.inflate(R.layout.edit_layout_custom_dialog, null);
        }
...
*/
      ...
      /* int width = (int) (getResources().getDisplayMetrics().widthPixels * 0.80);
       ...
       // dialog.getWindow().setLayout(R.dimen, height);
       // dialog.show();
